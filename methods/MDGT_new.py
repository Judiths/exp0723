    ...
    def pre_optimal_ass(self):
        ...
        for l in range(1000):
            if not self.tasks_pool.empty():
                ...
                ass1, f1, delays1 = opts.ass1(tl1, et1)
                pre_opt_ass += delays1
            else:
                break
            ...
            if not self.tasks_pool.empty():
                ...
                wl = opts.wl(tl2, l)
                ass2, f2, delays2 = opts.ass2(tl2, wl, et2)
                pre_opt_ass += delays2
            else:
                break
            ...
            if not self.tasks_pool.empty():
                ...
                ass3, f3, delays3 = opts.ass3(tl3, et3, pt3)
                pre_opt_ass += delays3
            else:
                break
...
if __name__ == '__main__':
    ...
    mdgt = MDGT(task_pool, V, pos)

    # 预分配策略
    pre_optimal_ass = mdgt.pre_optimal_ass()
    print(pre_optimal_ass, pos)

    # 本机部署模拟
    use_submit(pre_optimal_ass, pos)
